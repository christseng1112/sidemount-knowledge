...
1. **Al Ghais Diving** - *The Evolution of Sidemount Diving*: 詳細記載了側掛從早期英國 Sump diving 到商業標準化課程的轉變。 [連結](https://www.alghaisdiving.com)
2. **Scuba Tech Philippines** - *The History of Sidemount*: 深入剖析了 Cave Diving Group (CDG) 早期所使用的 "English System" 及其演進細節。 [連結](https://www.scubatechphilippines.com)
3. **Scribd** - *Sidemount History & Manuals*: Woody Jasper 及其團隊在佛羅里達對於 BCD 的改裝與氣瓶位置上移的歷史記錄。 [連結](https://www.scribd.com)
4. **Adrex Group** - *Lamar Hires and the Development of Transpac*: 記述了 Dive Rite 如何將探索用改裝裝備規格化為市場產品的歷史。 [連結](https://www.adrex.com)
5. **Go Sidemount (Razor)** - *Steve Bogaerts' Razor System Philosophy*: Steve Bogaerts 對於極簡主義在側掛系統中應用的原創文獻。 [連結](https://www.razorgosidemount.com)
6. **Filoarianna Dive** - *The Revolution of Sidemount in Mexico*: 探討墨西哥岑諾特洞穴探索對現代超薄側掛氣囊發展的決定性影響。 [連結](https://www.filoariannadive.com)
7. **Sidemounting.com** - *Sidemount Pioneers and Systems*: 對於 Razor 及各流派系統歷史的深度評測與訪談。 [連結](https://www.sidemounting.com)
8. **TDI/SDI Blog** - *The Standardization of Sidemount Training*: 闡述技術潛水協會如何建立現代側掛安全標準與雙瓶氣體交換程序。 [連結](https://www.tdisdi.com)
