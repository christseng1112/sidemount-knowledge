...
5.  **完全開啟**：以**逆時針方向**將右瓶閥完全旋開到底。**現代技術潛水標準為「完全開啟、不回轉」**（GUE 與多數技術機構之現行教法），不要再往回轉（理由見下節） [1][4][5]。
...
5.  **完全開啟**：以**逆時針方向**完全旋開左瓶閥到底，**同樣維持完全開啟、不回轉** [4][5]。

### 步驟 5：流程檢查與確認 (Flow Check)
確認兩側氣瓶皆已重新開啟。看一眼左右兩側的壓力錶（SPG）確認數值，向潛伴做出「OK」手勢，結束演練 [2]。
...
> ⚠️ **重要更正**：早期技術潛水曾教「完全旋開後再往回轉 1/4 圈」。**此為過時做法，現已不建議**。GUE 與多數現代技術機構（含 TDI 新版教材）現行標準為「**完全旋開到底，不回轉，並維持整潛全開**」 [1][4][5]。

過去回轉的兩個理由，在現代裝備與事故檢討後均已被推翻或反證：

1.  **「防止高壓鎖死」已不成立**：早期回轉的原意是防止舊式閥座被旋到底卡死。**現代閥（DIN/Pro valve）的螺紋與閥座設計已不會因完全開啟而鎖死**，無須預留回轉行程 [5]。
2.  **回轉反而製造致命誤判（核心安全理由）**：
    *   若閥門「完全開啟（轉不動）」，檢查者一扭發現轉不動，正確結論應是「已全開」。
    *   但若依舊做法回轉了半圈/一圈，閥門**左右都有自由行程**，檢查者無法分辨它是「全開後回轉」還是「全關後開一點」。一旦檢查者誤判為關閉而「先關死再開一點點」，潛水員就會帶著**半開閥**下水——深處流量不足、吸不到氣，比完全關閉更難察覺、更致命 [5]。
