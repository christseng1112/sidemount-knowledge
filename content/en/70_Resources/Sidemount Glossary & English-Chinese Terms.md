---
title: Sidemount Glossary & English-Chinese Terms
tags:
  - sidemount/resources
  - status/completed
---

# Sidemount Glossary & English-Chinese Terms (Sidemount EN-ZH Glossary)

This glossary compiles the core terminology used throughout this knowledge base. The Chinese terms are based on standard terminology in the Taiwanese diving community. The primary purpose of learning these terms is for clear communication rather than translation—directly use the English terms when diving with international buddies or training with foreign instructors.
...
| EMT shears / Trauma shears | 醫療剪 | Scissors used to cut thick line, netting, or thin wire. |
| Line arrow | 線箭 | Triangular plastic marker pointing toward the cave or wreck exit. |
| Wet notes | 濕板 / 水寫本 | In-water notebook used for profiles, plans, and communications. |

## 🏊 Skills

| English Term | Traditional Chinese | Description / Reference |
| :--- | :--- | :--- |
| Trim | 配平 / 水平姿態 | In-water horizontal alignment. See [[en/30_Skills/In-Water Buoyancy & Horizontal Trim|In-Water Buoyancy & Horizontal Trim]]. |
| Buoyancy | 浮力（控制） | General control of ascent, descent, and hovering. |
...
| Flow check | 流量檢查 | Verifying that cylinder valves are fully open. |
| Purge | 排水（按鈕） | Second stage manual purge button. |
| Donate | 捐氣 | Handing your regulator to an out-of-gas (OOG) diver. |
| No-mount | 無掛載 | Cylinder removal technique. See [[en/60_Advanced/No-Mount & Stage Dropping Techniques|No-Mount & Stage Dropping Techniques]]. |

## 📊 Gas & Decompression

| English Term | Traditional Chinese | Description / Reference |
| :--- | :--- | :--- |
| SAC (Surface Air Consumption) | 壓力呼吸率 | Gas consumption rate at 1 ATA. See [[en/40_Gas_Management/Gas Consumption Rate (SAC & RMV) Calculation|Gas Consumption Rate (SAC & RMV) Calculation]]. |
...
| Omitted decompression | 遺漏減壓 | Decompression skipped due to an emergency. |
| END (Equivalent Narcotic Depth) | 等效麻醉深度 | Equivalent nitrogen narcosis depth using Trimix. |
| ppO₂ | 氧分壓 | Partial pressure of oxygen. |
| Gas density | 氣體密度 | Gas density in g/L. See [[en/60_Advanced/Trimix Gas & Gas Density Planning|Trimix Gas & Gas Density Planning]]. |
| Gradient Factors (GF) | 梯度因子 | Safety scaling factors. See [[en/40_Gas_Management/Decompression Planning Software & Gradient Factors|Decompression Planning Software & Gradient Factors]]. |
| NDL (No-Decompression Limit) | 免減壓限度 | Time remaining before decompression stops are required. |
| Deco stop / Safety stop | 減壓停留 / 安全停留 | Mandatory or advisory halts during ascent. See [[en/50_Safety/Ascent Rate & Safety Stop Standards|Ascent Rate & Safety Stop Standards]]. |
| Runtime | 潛水時程表 | Time-versus-depth decompression schedule. |
| Gas switch | 氣體切換 | Technical gas change procedure. See [[en/40_Gas_Management/Sidemount Gas Switching Procedures|Sidemount Gas Switching Procedures]]. |
| Nitrox (EANx) | 高氧混合氣 | Nitrogen-oxygen gas mixture. |
| Trimix | 三元混合氣 | Oxygen-helium-nitrogen gas mixture. |

## 🚨 Safety & Environment

| English Term | Traditional Chinese | Description / Reference |
| :--- | :--- | :--- |
| OOG (Out of Gas) | 氣源耗盡 | Out-of-gas state. See [[en/50_Safety/Out of Gas (OOG) & Long Hose Sharing Procedure|Out of Gas (OOG) & Long Hose Sharing Procedure]]. |
| Freeflow | （調節器）持續漏氣 | Continuous valve leakage. See [[en/50_Safety/Sidemount Regulator Malfunction & Leak Management|Sidemount Regulator Malfunction & Leak Management]]. |
| CESA | 控制式緊急游泳上升 | Controlled Emergency Swimming Ascent. See [[en/50_Safety/Controlled Emergency Swimming Ascent (CESA) & Last Resort Options|Controlled Emergency Swimming Ascent (CESA) & Last Resort Options]]. |
| DCS / DCI / AGE | 減壓症 / 減壓疾病 / 動脈氣體栓塞 | Decompression diseases. See [[en/50_Safety/DCS Symptom Recognition & Oxygen First Aid|DCS Symptom Recognition & Oxygen First Aid]]. |
| Narcosis | 氮醉 / 氣體麻醉 | Nitrogen or gas narcosis. |
| Hypothermia | 失溫 | Drop in core body temperature. See [[en/50_Safety/Hypothermia Prevention & Management|Hypothermia Prevention & Management]]. |
| Silt-out | 揚沙（能見度歸零） | Total loss of visibility from disturbed sediment. |
| Guideline | 導引線 | Cave or wreck guide string. See [[en/60_Advanced/Sidemount Guidelines & Operations in Overhead Environments|Sidemount Guidelines & Operations in Overhead Environments]]. |
| Lost line / Lost buddy | 迷失導引線 / 失散 | Overhead separation emergencies. See [[en/50_Safety/Team Separation & Lost Diver SOP|Team Separation & Lost Diver SOP]]. |
| Restriction | 狹窄段 / 限制通道 | Passages narrower than standard body profiles. |
| Overhead environment | 頂部封閉環境 | Cave, wreck, or under-ice environments. |
| Penetration | 穿越 / 滲透 | Entering an overhead space. |
| Touch contact | 觸摸接觸 | Communication via touch in silt-outs. See [[en/30_Skills/Team Hand Signals, Light & Touch Communication|Team Hand Signals, Light & Touch Communication]]. |
| Entanglement | （線材）纏繞 | Entrapment by fishing lines or nets. Emergency SOP in [[en/50_Safety/Line Entanglement & Cutting Tool Configuration|Line Entanglement & Cutting Tool Configuration]]. |
| Equalization | 耳壓平衡 / 平壓 | Middle ear equalization. See [[en/50_Safety/Ear Equalization & Barotrauma|Ear Equalization & Barotrauma]]. |
...
> 📌 This table serves as an **internal cross-reference document**. Definitive explanations of terms should be verified in their respective linked articles.
