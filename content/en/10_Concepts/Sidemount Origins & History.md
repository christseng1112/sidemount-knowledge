---
title: Sidemount Origins & History
tags:
  - sidemount/concepts
  - status/completed
---
...
```mermaid
timeline
    title Timeline of Sidemount Diving History
    1960s : British Cave Diving Group (CDG) : Birth of the "English System"; used for passing through brief submerged passages (sumps)
    1970s-1980s : Florida "Mole Tribe" : Woody Jasper refines configuration; cylinders moved to armpits, BCD and Trim concepts introduced
    2000s : Mexico Cave Exploration & Modernization : Steve Bogaerts develops Razor System; integrates DIR/Hogarthian philosophy and establishes modern training standards
    2010s-Present : Global Mainstream & Commercialization : PADI, TDI, IANTD launch courses; sidemount enters recreational and technical markets
```
