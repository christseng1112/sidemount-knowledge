---
title: Out of Gas (OOG) & Long Hose Sharing Procedure
tags:
  - sidemount/safety
  - status/completed
---
...
```mermaid
flowchart TD
    OOG["🚨 Buddy Out of Gas (OOG) / Signal Sent / Regulator Grabbed"] --> Donate["1. Actively Donate Regulator in Mouth<br>(Protect mouthpiece with thumb, hand to receiver)"]
    Donate --> Switch["2. Self Gas Switch<br>(Tilt head down, insert necklace backup regulator)"]
    Switch --> Stabilize["3. Stabilize Receiver<br>(Verify breathing, establish eye contact)"]
    Stabilize --> Deploy["4. Deploy and Clear Long Hose<br>(Tilt head down, pull hose free, clear entanglements)"]
    Deploy --> CheckSPG["5. Team Control & SPG Check<br>(Maintain physical contact, read both SPGs)"]
    CheckSPG --> ChooseFormation{"🌐 Select Exit Formation"}
    
    ChooseFormation -->|"Wide Channel"| SideBySide["Side-by-Side Exit<br>- Firmly grasp receiver's shoulder strap<br>- Monitor ascent rate together"]
    ChooseFormation -->|"Narrow Channel"| SingleFile["Single-File Exit<br>- Donor leads, tracking guideline<br>- Receiver follows, holding donor's valve/waist"]
    
    SideBySide --> Exit["6. Maintain Trim, ascend to surface at controlled rate"]
    SingleFile --> Exit
```
