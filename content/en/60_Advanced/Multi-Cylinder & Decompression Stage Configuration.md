---
title: Multi-Cylinder & Decompression Stage Configuration (Technical Sidemount)
tags:
  - sidemount/advanced
  - status/completed
---

# Multi-Cylinder & Decompression Stage Configuration (Technical Sidemount Stage & Deco Setup)

When sidemount diving crosses into technical decompression territory, divers must carry additional cylinders on their sides—**decompression cylinders (Deco Cylinders)** and **travel/stage cylinders (Stage Cylinders)**. While maintaining the primary sidemount cylinders flush against the torso and keeping the right-side 2.1m long hose deployable at all times, the geometry, clipping order, and buoyancy balance of multi-cylinder configurations demand extremely rigorous standards [1][2][3].

This article details Stage/Deco cylinder rigging standards, the **left-side priority principle**, **layering geometry**, and multi-cylinder in-water trim techniques.

---

## ⚙️ Stage / Deco Cylinder Rigging Standards (No Metal-to-Metal)

Additional cylinders for technical sidemount (typically AL40 or AL80 aluminum cylinders) must follow standardized rigging protocols [1][7]:

1.  **Top Clip**: A single bolt snap, attached to the cylinder neck with high-strength nylon cord (braided line or webbing), positioned just below the valve body [1][7].
2.  **Bottom Clip**: A stainless steel hose clamp (Jubilee Band) secured to the lower-mid section of the cylinder, covered with a rubber protector, with a bolt snap attached via nylon cord [1][7].
3.  **No Metal-to-Metal Rule**: **No metal rings, shackles, or chains may directly connect the bolt snap to the cylinder clamp. All connections must use cuttable nylon cord** [2].
    *   *Safety Mechanism*: In an extreme entanglement or if a bolt snap jams on a D-ring and cannot be released, the diver must be able to **cut through the nylon cord with a knife or shears** to jettison the cylinder and self-rescue. A metal-to-metal connection eliminates this escape path [2].
...
【Technical Sidemount Cross-Section (Top View)】
              ...
              [ Spine Ballast Weight ]
                 /      \
      [Left Primary] ──●──────●── [Right Primary]
      [Left Deco Cyl]             (Right side kept clear for long hose deployment)
      [Left Stage Cyl]           (Right side only receives extra deco when carrying 4+ cylinders)
```
...
## 🥞 Multi-Cylinder Layering Geometry

When two cylinders are mounted simultaneously on the left side (e.g., a 12L stage and a 5.7L deco cylinder), layering is required to maintain trim and minimize drag [3][6]:
...
## ⚖️ Multi-Cylinder In-Water Trim & Buoyancy Control
