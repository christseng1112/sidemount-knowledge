---
title: 側掛背帶與浮力補償裝置 (BCD)
tags:
  - sidemount/equipment
  - status/completed
---

# 側掛背帶與浮力補償裝置 (BCD / Harness & Wing)

在側掛潛水中，**背帶（Harness）**與**浮力補償氣囊（Wing/Bladder）**是支撐整套系統骨架與維持水中配平（Trim）的核心。與休閒潛水常見的夾克式 BCD 不同，側掛的背帶與氣囊往往採用分離式或模組化設計，以追求最極致的流線型與水中活動度。

本篇將系統性剖析側掛背帶的受力結構、氣囊的設計要素、雙囊備用系統，以及兩大核心設計流派的對比。

---

## 📐 背帶系統 (Harness Systems) 的幾何受力

側掛背帶的核心目的是**將氣瓶的沉重重量均勻分佈在潛水員的骨骼上，並在水中牢固鎖定氣瓶的位置**。

```
              [ 肩帶 ] ──> 承受氣瓶上半部的拉力，定位胸前 D 環
                 │
  [ 脊椎帶 ] ───┼─── [ 腰帶 ] ──> 承載配重與下半部氣瓶夾，定位臀部/滑動 D 環
                 │
              [ 胯帶 ] ──> 防止系統在水中（尤其是氣囊充氣時）往頭部滑動
```
...
## 🎈 浮力補償氣囊 (Wing / Bladder) 的設計要素

側掛氣囊必須在提供足夠浮力的同時，維持最低的**迎水截面積** [5]。

### 1. 低剖面（Low Profile）與三角扁平外型
側掛氣囊（如 **[[Razor 側掛系統調整與配置|Razor 4.0]]** 的 BAT Wing 4 或 **[[XDEEP Stealth 2.0 系統調整與配置|XDEEP Stealth 2.0]]**）充氣時向兩側扁平擴展，氣囊中央呈超薄設計貼合背脊。這確保了潛水員在水中轉身時不會有「氣體左右晃動」的不穩定感 [2][5]。

### 2. 浮力容量與重心分佈 (Lift Capacity & Gravity Alignment)
*   **休閒/鋁瓶配置**：通常需要 **20 - 30 磅 (9 - 13 kg)** 的浮力，外型極度輕量化。
*   **技術/鋼瓶/多瓶配置**：需要 **35 - 45 磅 (16 - 20 kg)** 的浮力，以應對多支負浮力氣瓶 [2][6]。
*   **浮力分佈（中下背集中）**：側掛氣囊的浮力中心通常設計在**中下背部與臀部上方**。這是因為潛水員的肺部本身就提供上半身浮力，而氣瓶底部、配重及雙腿呈負浮力。浮力集中在下半身能完美抵消下沉力，實現自然的水平 Trim [2][5][7]。

---

## 🚨 雙氣囊 (Dual Bladder) 備用浮力系統
...
側掛 BCD 發展至今，形成了兩大鮮明的設計流派：

### 🟢 英式極簡流派 (Minimalist - 以 Razor 4.0 為代表)
*   **哲學**：極簡、無重力、「第二層皮膚」。
*   **結構**：一體式織帶，氣囊極薄且緊貼背部，無厚重的肩膀或腰部護墊。配重與系統完全融合 [2][10]。
*   **優勢**：在水中阻力最小，轉身極度靈活，適合穿越極窄空間。
*   **劣勢**：陸上穿戴時，沒有護墊保護，重氣瓶的壓迫感較明顯，對骨骼的直接壓迫感重 [10]。

### 🔵 美式/模組防護流派 (Modular/Heavy Duty - 以 XDEEP / Hollis 為代表)
*   **哲學**：模組化、強大防護力、高負載性。
*   **結構**：獨立式肩膀與腰部織帶，配有厚實的肩膀與腰部護墊，氣囊外殼使用高丹尼數防彈尼龍或防刮甲殼材質 [6][10]。
*   **優勢**：陸上穿戴極度舒適，抗磨損防刮能力極強，適合粗暴的岸潛、沉船外殼擦撞，且擴充掛載 Stage 氣瓶極為方便 [6][10]。
*   **劣勢**：水中剖面較大，水中自重較重，阻力略高於極簡系統。
...
5. **Sidemount Pros** - *Wing Design and Water Resistance*: 專業側掛教練分析扁平低剖面氣囊對降低水中阻力與維持平衡的影響。 [連結](https://www.sidemountpros.com)
6. **XDEEP Support** - *Stealth 2.0 Tec vs Classic Lift Distribution*: XDEEP 官方解析 Tec 版大浮力氣囊在鋼瓶配置下的平衡力學。 [連結](https://www.xdeep.eu)
7. **SSSI Blog** - *How Buoyancy Center Affects Your Swimming Profile*: 探討氣囊浮力中心下移對修正下半身配平的物理機制。 [連結](https://www.divessi.com)
