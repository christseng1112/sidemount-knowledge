...
1. **XDEEP（官方產品頁）** - *STEALTH 2.0 TEC Setup sidemount system*: 官方產品規格（19 kg 升力、中央排氣閥、Cordura 1100 外殼）與適用環境說明；REC/Classic 規格見官網同系列頁。 [連結](https://www.xdeep.eu/sidemount-bc-wing-stealth-tec-pr-106.html)
2. **DirDirect** - *XDeep Stealth 2.0 Classic Sidemount System*（產品頁）: Classic 版氣囊構造與配置選項之經銷技術說明。 [連結](https://www.dirdirect.com/products/xdeep-stealth-2-0-side-mount-system)
3. **XDEEP（官方）** - *STEALTH 2.0 TEC User Manual*（官方 PDF）: 技術版 19 kg 氣囊配置與底部中央排氣閥操作指南。 [連結](https://www.xdeep.eu/files/manuals/xdeep_stealth_tec_manual_en.pdf)
4. **XDEEP（官方）** - *User Manual Download Hub*: 官方手冊下載總頁（Classic/TEC/REC 手冊與 CE 證書）。 [連結](https://www.xdeep.eu/user-manual-download-nsc-6.html)
5. **Audrey Cudel Technical** - *XDEEP Stealth 2.0 TEC Sidemount System*（產品/教學頁）: 獨立肩腰織帶模組化與脊椎配重袋移位之教學調整觀點。 [連結](https://audreycudel.com/products/xdeep-stealth-2-tec-sidemount-system)
6. **Cenote Girl (Mexico Cave Training)** - *XDeep Stealth 2.0 Tec vs Rec: Which Fits You Best*: 洞穴教學視角下 Stealth 系列配重與氣囊尺寸實測（含與 Razor 對比）。 [連結](https://cenotegirl.com/blog-3-1/xdeep-stealth-20-tec-vs-rec-which-fits-you-best)
7. **Sidemount Pros** - *Mastering the Four Foundations of Sidemount Diving*: Trim/Balance/Stability 力學框架下的系統微調與配重原則。 [連結](https://www.sidemountpros.com/blog/2016/3/8/1y1q6jlqoghh32sqb5uggi2s4ispwl)
8. **ScubaBoard** - *Razor Go Sidemount Course worth it? Razor 4.0 vs XDeep Stealth 2.0 Tec*: 兩系統穿脫、耐久與配重分佈之社群實測討論（社群來源，僅供補充）。 [連結](https://scubaboard.com/community/threads/razor-go-sidemount-course-worth-it-razor-4-0-vs-xdeep-stealth-2-0-tec.660938/)
9. **Scuba Tech Philippines (Andy Davis)** - *XDeep Stealth Tec vs Hollis Katana 2 Reviewed*: XDEEP 模組化設計、防護與細節之深度評測。 [連結](https://scubatechphilippines.com/scuba_blog/xdeep-stealth-tec-hollis-katana-2-review/)
10. **DirDirect** - *XDeep Stealth Central Weight Pocket*（產品頁）: 脊椎配重袋尺寸、容量與防釋放鎖扣安裝方式。 [連結](https://www.dirdirect.com/products/xdeep-stealth-central-weight-pocket)
11. **Sidemounting.com** - *xDeep Systems Comparison Review*（影音課程頁）: XDEEP 系列與其他系統（含彈性繩配置差異）之對比評測。 [連結](https://www.sidemounting.com/lesson/xdeep-systems-comparison-review-7-min/)
12. **YouTube (Garry Dallas / Simply Sidemount)** - *Sidemount Inflator system configuration — "Ask Garry"*: XDEEP 充氣管走線與背帶客製化微調示範（影音來源，僅供補充）。 [連結](https://www.youtube.com/watch?v=m56fzlc0aq0)
13. **XDEEP（官方一手資料）** - *STEALTH 2.0 User Manual & STEALTH 2.0 TEC User Manual, Revision 3 (2015)*（官方 PDF）：涵蓋三種彈性繩裝法（官方建議獨立繩/浮動環而非連續繩）、五點式背帶、CWP 高度可調、可拋腰袋 2×3／2×6 kg、技術規格（Classic 16 kg／Tec 19 kg、Cordura 1100＋Nylon 440 兩層結構、最大氣瓶 2×15L／4×15L、K-Type 充氣閥、每 200 潛保養）。 [連結](https://www.xdeep.eu/files/manuals/xdeep_stealth_manual_en.pdf)
